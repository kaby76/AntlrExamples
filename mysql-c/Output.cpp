...
int mysql::Output::changed = 0;
bool mysql::Output::first_time = true;

std::string mysql::Output::OutputTokens(antlr4::CommonTokenStream& stream)
{
    std::string sb;
...
std::string mysql::Output::OutputTree(antlr4::tree::ParseTree& tree, antlr4::CommonTokenStream& stream)
{
    std::string sb;
...
void mysql::Output::ParenthesizedAST(antlr4::tree::ParseTree& tree, std::string& sb, antlr4::CommonTokenStream& stream, int level)
{
...
void mysql::Output::StartLine(std::string& sb, antlr4::tree::ParseTree& tree, antlr4::CommonTokenStream& stream, int level)
{
    if (changed - level >= 0)
    {
        if (!first_time)
...
bool mysql::Output::replace(std::string& str, const std::string& from, const std::string& to) {
...
std::string mysql::Output::ToLiteral(std::string& input)
{
...
std::string mysql::Output::PerformEscapes(std::string s)
{
    std::string new_s;
