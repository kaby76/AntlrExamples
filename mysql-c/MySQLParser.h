...
public:
  ...
  enum {
    ...
    RuleExceptRoleList = 258, RuleWithRoles = 259, RuleGrantAs = 260, RuleVersionedRequireClause = 261, 
    RuleRenameUser = 262, RuleRevoke = 263, RuleOnTypeTo = 264, RuleAclType = 265, 
    RuleSetPassword = 266, RuleRoleOrPrivilegesList = 267, RuleRoleOrPrivilege = 268, 
    RuleGrantIdentifier = 269, RuleRequireList = 270, RuleRequireListElement = 271, 
    RuleGrantOption = 272, RuleSetRole = 273, RuleRoleList = 274, RuleRole = 275, 
    RuleTableAdministrationStatement = 276, RuleHistogram = 277, RuleCheckOption = 278, 
    RuleRepairType = 279, RuleInstallUninstallStatment = 280, RuleSetStatement = 281, 
    RuleOptionValueNoOptionType = 282, RuleSetSystemVariable = 283, RuleOptionValueFollowingOptionType = 284, 
    RuleSetExprOrDefault = 285, RuleOptionValueList = 286, RuleOptionValue = 287, 
    RuleShowStatement = 288, RuleShowCommandType = 289, RuleNonBlocking = 290, 
    RuleFromOrIn = 291, RuleInDb = 292, RuleProfileType = 293, RuleOtherAdministrativeStatement = 294, 
    RuleKeyCacheListOrParts = 295, RuleKeyCacheList = 296, RuleAssignToKeycache = 297, 
    RuleAssignToKeycachePartition = 298, RuleCacheKeyList = 299, RuleKeyUsageElement = 300, 
    RuleKeyUsageList = 301, RuleFlushOption = 302, RuleLogType = 303, RuleFlushTables = 304, 
    RuleFlushTablesOptions = 305, RulePreloadTail = 306, RulePreloadList = 307, 
    RulePreloadKeys = 308, RuleAdminPartition = 309, RuleResourceGroupManagement = 310, 
    RuleCreateResourceGroup = 311, RuleResourceGroupVcpuList = 312, RuleVcpuNumOrRange = 313, 
    RuleResourceGroupPriority = 314, RuleResourceGroupEnableDisable = 315, 
    RuleAlterResourceGroup = 316, RuleSetResourceGroup = 317, RuleThreadIdList = 318, 
    RuleDropResourceGroup = 319, RuleUtilityStatement = 320, RuleDescribeCommand = 321, 
    RuleExplainCommand = 322, RuleExplainableStatement = 323, RuleHelpCommand = 324, 
    RuleUseCommand = 325, RuleRestartServer = 326, RuleExpr = 327, RuleBoolPri = 328, 
    RuleCompOp = 329, RulePredicate = 330, RulePredicateOperations = 331, 
    RuleBitExpr = 332, RuleSimpleExpr = 333, RuleArrayCast = 334, RuleJsonOperator = 335, 
    RuleSumExpr = 336, RuleGroupingOperation = 337, RuleWindowFunctionCall = 338, 
    RuleWindowingClause = 339, RuleLeadLagInfo = 340, RuleNullTreatment = 341, 
    RuleJsonFunction = 342, RuleInSumExpr = 343, RuleIdentListArg = 344, 
    RuleIdentList = 345, RuleFulltextOptions = 346, RuleRuntimeFunctionCall = 347, 
    RuleGeometryFunction = 348, RuleTimeFunctionParameters = 349, RuleFractionalPrecision = 350, 
    RuleWeightStringLevels = 351, RuleWeightStringLevelListItem = 352, RuleDateTimeTtype = 353, 
    RuleTrimFunction = 354, RuleSubstringFunction = 355, RuleFunctionCall = 356, 
    RuleUdfExprList = 357, RuleUdfExpr = 358, RuleVariable = 359, RuleUserVariable = 360, 
    RuleSystemVariable = 361, RuleInternalVariableName = 362, RuleWhenExpression = 363, 
    RuleThenExpression = 364, RuleElseExpression = 365, RuleCastType = 366, 
    RuleExprList = 367, RuleCharset = 368, RuleNotRule = 369, RuleNot2Rule = 370, 
    RuleInterval = 371, RuleIntervalTimeStamp = 372, RuleExprListWithParentheses = 373, 
    RuleExprWithParentheses = 374, RuleSimpleExprWithParentheses = 375, 
    RuleOrderList = 376, RuleOrderExpression = 377, RuleGroupList = 378, 
    RuleGroupingExpression = 379, RuleChannel = 380, RuleCompoundStatement = 381, 
    RuleReturnStatement = 382, RuleIfStatement = 383, RuleIfBody = 384, 
    RuleThenStatement = 385, RuleCompoundStatementList = 386, RuleCaseStatement = 387, 
    RuleElseStatement = 388, RuleLabeledBlock = 389, RuleUnlabeledBlock = 390, 
    RuleLabel = 391, RuleBeginEndBlock = 392, RuleLabeledControl = 393, 
    RuleUnlabeledControl = 394, RuleLoopBlock = 395, RuleWhileDoBlock = 396, 
    RuleRepeatUntilBlock = 397, RuleSpDeclarations = 398, RuleSpDeclaration = 399, 
    RuleVariableDeclaration = 400, RuleConditionDeclaration = 401, RuleSpCondition = 402, 
    RuleSqlstate = 403, RuleHandlerDeclaration = 404, RuleHandlerCondition = 405, 
    RuleCursorDeclaration = 406, RuleIterateStatement = 407, RuleLeaveStatement = 408, 
    RuleGetDiagnostics = 409, RuleSignalAllowedExpr = 410, RuleStatementInformationItem = 411, 
    RuleConditionInformationItem = 412, RuleSignalInformationItemName = 413, 
    RuleSignalStatement = 414, RuleResignalStatement = 415, RuleSignalInformationItem = 416, 
    RuleCursorOpen = 417, RuleCursorClose = 418, RuleCursorFetch = 419, 
    RuleSchedule = 420, RuleColumnDefinition = 421, RuleCheckOrReferences = 422, 
    RuleCheckConstraint = 423, RuleConstraintEnforcement = 424, RuleTableConstraintDef = 425, 
    RuleConstraintName = 426, RuleFieldDefinition = 427, RuleColumnAttribute = 428, 
    RuleColumnFormat = 429, RuleStorageMedia = 430, RuleGcolAttribute = 431, 
    RuleReferences = 432, RuleDeleteOption = 433, RuleKeyList = 434, RuleKeyPart = 435, 
    RuleKeyListWithExpression = 436, RuleKeyPartOrExpression = 437, RuleKeyListVariants = 438, 
    RuleIndexType = 439, RuleIndexOption = 440, RuleCommonIndexOption = 441, 
    RuleVisibility = 442, RuleIndexTypeClause = 443, RuleFulltextIndexOption = 444, 
    RuleSpatialIndexOption = 445, RuleDataTypeDefinition = 446, RuleDataType = 447, 
    RuleNchar = 448, RuleVarchar = 449, RuleNvarchar = 450, RuleRealType = 451, 
    RuleFieldLength = 452, RuleFieldOptions = 453, RuleCharsetWithOptBinary = 454, 
    RuleAscii = 455, RuleUnicode = 456, RuleWsNumCodepoints = 457, RuleTypeDatetimePrecision = 458, 
    RuleCharsetName = 459, RuleCollationName = 460, RuleCreateTableOptions = 461, 
    RuleCreateTableOptionsSpaceSeparated = 462, RuleCreateTableOption = 463, 
    RuleTernaryOption = 464, RuleDefaultCollation = 465, RuleDefaultEncryption = 466, 
    RuleDefaultCharset = 467, RulePartitionClause = 468, RulePartitionTypeDef = 469, 
    RuleSubPartitions = 470, RulePartitionKeyAlgorithm = 471, RulePartitionDefinitions = 472, 
    RulePartitionDefinition = 473, RulePartitionValuesIn = 474, RulePartitionOption = 475, 
    RuleSubpartitionDefinition = 476, RulePartitionValueItemListParen = 477, 
    RulePartitionValueItem = 478, RuleDefinerClause = 479, RuleIfExists = 480, 
    RuleIfNotExists = 481, RuleProcedureParameter = 482, RuleFunctionParameter = 483, 
    RuleCollate = 484, RuleTypeWithOptCollate = 485, RuleSchemaIdentifierPair = 486, 
    RuleViewRefList = 487, RuleUpdateList = 488, RuleUpdateElement = 489, 
    RuleCharsetClause = 490, RuleFieldsClause = 491, RuleFieldTerm = 492, 
    RuleLinesClause = 493, RuleLineTerm = 494, RuleUserList = 495, RuleCreateUserList = 496, 
    RuleAlterUserList = 497, RuleCreateUserEntry = 498, RuleAlterUserEntry = 499, 
    RuleRetainCurrentPassword = 500, RuleDiscardOldPassword = 501, RuleReplacePassword = 502, 
    RuleUser = 503, RuleLikeClause = 504, RuleLikeOrWhere = 505, RuleOnlineOption = 506, 
    RuleNoWriteToBinLog = 507, RuleUsePartition = 508, RuleFieldIdentifier = 509, 
    RuleColumnName = 510, RuleColumnInternalRef = 511, RuleColumnInternalRefList = 512, 
    RuleColumnRef = 513, RuleInsertIdentifier = 514, RuleIndexName = 515, 
    RuleIndexRef = 516, RuleTableWild = 517, RuleSchemaName = 518, RuleSchemaRef = 519, 
    RuleProcedureName = 520, RuleProcedureRef = 521, RuleFunctionName = 522, 
    RuleFunctionRef = 523, RuleTriggerName = 524, RuleTriggerRef = 525, 
    RuleViewName = 526, RuleViewRef = 527, RuleTablespaceName = 528, RuleTablespaceRef = 529, 
    RuleLogfileGroupName = 530, RuleLogfileGroupRef = 531, RuleEventName = 532, 
    RuleEventRef = 533, RuleUdfName = 534, RuleServerName = 535, RuleServerRef = 536, 
    RuleEngineRef = 537, RuleTableName = 538, RuleFilterTableRef = 539, 
    RuleTableRefWithWildcard = 540, RuleTableRef = 541, RuleTableRefList = 542, 
    RuleTableAliasRefList = 543, RuleParameterName = 544, RuleLabelIdentifier = 545, 
    RuleLabelRef = 546, RuleRoleIdentifier = 547, RuleRoleRef = 548, RulePluginRef = 549, 
    RuleComponentRef = 550, RuleResourceGroupRef = 551, RuleWindowName = 552, 
    RulePureIdentifier = 553, RuleIdentifier = 554, RuleIdentifierList = 555, 
    RuleIdentifierListWithParentheses = 556, RuleQualifiedIdentifier = 557, 
    RuleSimpleIdentifier = 558, RuleDotIdentifier = 559, RuleUlong_number = 560, 
    RuleReal_ulong_number = 561, RuleUlonglong_number = 562, RuleReal_ulonglong_number = 563, 
    RuleLiteral = 564, RuleSignedLiteral = 565, RuleStringList = 566, RuleTextStringLiteral = 567, 
    RuleTextString = 568, RuleTextStringHash = 569, RuleTextLiteral = 570, 
    RuleTextStringNoLinebreak = 571, RuleTextStringLiteralList = 572, RuleNumLiteral = 573, 
    RuleBoolLiteral = 574, RuleNullLiteral = 575, RuleTemporalLiteral = 576, 
    RuleFloatOptions = 577, RuleStandardFloatOptions = 578, RulePrecision = 579, 
    RuleTextOrIdentifier = 580, RuleLValueIdentifier = 581, RuleRoleIdentifierOrText = 582, 
    RuleSizeNumber = 583, RuleParentheses = 584, RuleEqual = 585, RuleOptionType = 586, 
    RuleVarIdentType = 587, RuleSetVarIdentType = 588, RuleIdentifierKeyword = 589, 
    RuleIdentifierKeywordsAmbiguous1RolesAndLabels = 590, RuleIdentifierKeywordsAmbiguous2Labels = 591, 
    RuleLabelKeyword = 592, RuleIdentifierKeywordsAmbiguous3Roles = 593, 
    RuleIdentifierKeywordsUnambiguous = 594, RuleRoleKeyword = 595, RuleLValueKeyword = 596, 
    RuleIdentifierKeywordsAmbiguous4SystemVariables = 597, RuleRoleOrIdentifierKeyword = 598, 
    RuleRoleOrLabelKeyword = 599
  };
