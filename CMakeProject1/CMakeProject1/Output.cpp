...
int json::Output::changed = 0;
bool json::Output::first_time = true;

std::string json::Output::OutputTokens(antlr4::CommonTokenStream& stream)
{
    std::string sb;
...
std::string json::Output::OutputTree(antlr4::tree::ParseTree& tree, antlr4::CommonTokenStream& stream)
{
    std::string sb;
...
void json::Output::ParenthesizedAST(antlr4::tree::ParseTree& tree, std::string& sb, antlr4::CommonTokenStream& stream, int level)
{
...
void json::Output::StartLine(std::string& sb, antlr4::tree::ParseTree& tree, antlr4::CommonTokenStream& stream, int level)
{
    if (changed - level >= 0)
    {
        if (!first_time)
...
bool json::Output::replace(std::string& str, const std::string& from, const std::string& to) {
...
std::string json::Output::ToLiteral(std::string& input)
{
...
std::string json::Output::PerformEscapes(std::string s)
{
    std::string new_s;
