...
DIMACROSS : [dD] [iI] [mM] [aA][cC][rR][oO][sS][sS]; //TODO
...
INDFOR : [iI][nN][dD][fF][oO][rR]; //TODO
INITIAL_      : [iI] [nN] [iI] [tT] [iI] [aA] [lL] | [iI] [nN] [iI] | [iI] [nN] [iI] [tT];
INLINE          : [iI] [nN] [lL] [iI] [nN] [eE];
INONLY : [iI][nN][oO][nN][lL][yY]; //TODO
INOUT :  [iI][nN][oO][uU][tT]; //TODO
...
NULLINIT : [nN][uU][lL][lL][iI][nN][iI][tT];//TODO
...
OUTONLY : [oO][uU][tT][oO][nN][lL][yY]; //TODO
...
SUPPRESS : [sS][uU][pP][pP][rR][eE][sS][sS]; //TODO
...
VALUELIST      : [vV][aA][lL][uU][eE][lL][iI][sS][tT]; //TODO
VALUELISTFROM      : [vV][aA][lL][uU][eE][lL][iI][sS][tT][fF][rR][oO][mM]; //TODO
VALUERANGE      : [vV][aA][lL][uU][eE][rR][aA][nN][gG][eE]; //TODO
